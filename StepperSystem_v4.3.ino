...
// Pin Declaration
#define Stepper_Pul   6   // Stepper Motor Driver Pulse
#define Stepper_Dir   5   // Stepper Motor Driver Direction
#define Sensor_Pin    3   // Photoelectric Sensor
#define EStop         2   // Latched Emergency Pushbutton

// Global Variables
const unsigned long Stepper_Speed = 1000;
